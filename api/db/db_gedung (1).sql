...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2021 at 02:46 PM
...
CREATE TABLE `acara` (
  ...
  `status` int(1) NOT NULL COMMENT '1 = Menunggu , 2 = Diterima , 3 = Di tolak , 4 = Selesai',
  `tipe_acara` int(1) NOT NULL COMMENT '1 = online , 2 = offline',
...
INSERT INTO `acara` (`id_acara`, `nama_acara`, `tanggal_mulai`, `tanggal_selesai`, `jumlah_peserta`, `id_kategori`, `deskripsi`, `id_pengguna`, `status`, `tipe_acara`, `created_at`) VALUES
(10, 'asdf', '2021-05-21', '2021-05-25', 10, 1, '<p>sdaf</p>\r\n', 10, 2, 1, '2021-05-01 19:06:10');
...
INSERT INTO `detail_acara` (`id_detail`, `id_acara`, `id_fasilitas`) VALUES
(6, 10, 7),
(8, 6, 7),
(9, 7, 9),
(10, 8, 11),
...
INSERT INTO `fasilitas` (`id_fasilitas`, `nama_fasilitas`, `gambar_fasilitas`, `keterangan`) VALUES
(11, 'Lampu ', '02f2d40e29059f64eb7dafdd7d9a9751.jpg', 'Jam Tangan 7friday');
...
INSERT INTO `kategori_acara` (`id_kategori`, `nama_acara`, `harga`, `createdDate`) VALUES
(1, 'Olahraga123', 120000, '2021-05-01 13:29:29'),
(2, 'Umum', 200000, '2021-05-01 13:29:29');
...
INSERT INTO `lampu` (`id_lampu`, `nama_lampu`, `keterangan`, `tindakan`, `apiKey`) VALUES
(2, 'Lampu Depan', 'Lampu atas dan bawah', 'Off', 'dsadsa'),
(3, 'admin/ sad', 'Jam Tangan 7friday', 'Off', '2131231');
...
INSERT INTO `pemberitahuan` (`id_pemberitahuan`, `keterangan`, `id_acara`, `id_pengguna`, `created_at`) VALUES
(1, 'Acara Anda Telah Diterima', 6, 10, '2021-04-20 00:38:10');
...
CREATE TABLE `pengguna` (
  ...
  `is_active` int(11) NOT NULL COMMENT '1 = on 2=off',
  `created_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `pengguna` (`id_pengguna`, `nama`, `email`, `alamat`, `nomor_telepon`, `kota_kab`, `provinsi`, `jenis_kelamin`, `password`, `foto_pengguna`, `token`, `kode_otp`, `status`, `is_active`, `created_at`) VALUES
(1, 'Admin', 'admin@admin.com', 'Jl.Nias', '12312313', '1101', '11', 'Pria', '21232f297a57a5a743894a0e4a801fc3', '', 'asdf1', '', 1, 0, '2021-02-26 16:54:48'),
(10, 'Ryan', 'Anthine11112@gmail.com', 'Jl.Nias', '0891531873213', '1101', '11', 'Pria', '202cb962ac59075b964b07152d234b70', '8af9c8263942c658fb86199305bbcf05.jpg', 'fadsfasfa', '12312312', 2, 1, '2021-03-13 20:45:33'),
(11, 'Ryan', 'qwq11111@gmail.com', 'Jl.Nias', '1111', '1101', '11', 'Pria', '202cb962ac59075b964b07152d234b70', '79cd74754a95f8752635ba31d95403cb.png', '', '3978', 2, 2, '2021-03-27 09:49:33');

-- --------------------------------------------------------

--
-- Table structure for table `profile_gedung`
--

CREATE TABLE `profile_gedung` (
  `id` int(11) NOT NULL,
  `nama` text NOT NULL,
  `deskripsi` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Dumping data for table `profile_gedung`
--

INSERT INTO `profile_gedung` (`id`, `nama`, `deskripsi`) VALUES
(1, 'Gedung Ngorangasdasdasd', 'Deskripsi ddldasfasfsaasdasdasdasd');
...
CREATE TABLE `surat` (
  ...
  `id_pengguna` int(11) NOT NULL,
  `id_pemberitahuan` int(11) NOT NULL,
  `jenis_surat` enum('Surat Perjanjian Kontrak','Surat Izin Penggunaan','Surat Penolakan','Surat Data Pemesanan Gedung') NOT NULL,
...
--
-- Table structure for table `unit_desa`
--

CREATE TABLE `unit_desa` (
  `id_unit` int(11) NOT NULL,
  `nama_unit` text NOT NULL,
  `gambar` text NOT NULL,
  `tgl_bentuk` date NOT NULL,
  `deskripsi` text NOT NULL,
  `created_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `unit_desa`
--

INSERT INTO `unit_desa` (`id_unit`, `nama_unit`, `gambar`, `tgl_bentuk`, `deskripsi`, `created_at`) VALUES
(3, 'RYAN HARTADI', 'd394f9aab62073e9e4eae563dbc447ea.jpg', '2021-03-04', '<p>asddfa</p>\r\n', '2021-03-30 06:19:49');
...
--
-- Indexes for table `profile_gedung`
--
ALTER TABLE `profile_gedung`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `unit_desa`
--
ALTER TABLE `unit_desa`
...
--
-- AUTO_INCREMENT for table `profile_gedung`
--
ALTER TABLE `profile_gedung`
...
--
-- AUTO_INCREMENT for table `unit_desa`
--
ALTER TABLE `unit_desa`
