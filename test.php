 ...
 var arrkelas = [];
					...
					$(document).ready(function() {
							...
							$("#new").click(function() {
								...
								flag =1;
								arrexcel=[]
								var newRow = {add:"1",Site: site, PrinterLocation: "", Month:$('#tgl').val(),PrinterModel: "",UserDepartment:"",Usage:1};
					...
					for (var i = 0; i < ds.length; i++) 
						{
								var dataItem = $("#grid").data("kendoGrid").dataSource.data()[i];
										var Add = ds[i].add;
										var PrinterLocation = ds[i].PrinterLocation;
										...
										if (Add==1 && Site !== 'ALL')
										{
											...
											if  ( PrinterLocation !== ''  && PrinterModel !== ''  && Month !== ''
						...
						function creategrid(flagsrc) {
							...
							$("#grid").kendoGrid({
									...
									columns: [
									  ...
									  { field: "PrinterLocation",title:"Printer Location",
												editor:function(container,options)
													{
